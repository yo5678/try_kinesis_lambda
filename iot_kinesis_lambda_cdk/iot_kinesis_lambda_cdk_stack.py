...
from aws_cdk import Stack, aws_kinesis as kinesis, aws_lambda as _lambda
...
class IotKinesisLambdaCdkStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        topic_rule = iot.TopicRule(
            ...
            actions=[
                actions.KinesisPutRecordAction(stream, partition_key="${newuuid()}")
            ],
        )
        ...
        iot_kinesis_lambda.add_event_source(
            LambdaEventSources.KinesisEventSource(
                stream,
                batch_size=100,
